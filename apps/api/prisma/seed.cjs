...
async function main() {
  ...
  const channels = [
    ...
    },
    {
      ...
      category: 'MOVIES',
      sourceType: 'M3U8_FAST',
      externalId: 'https://stmv1.srvif.com/classique/classique/playlist.m3u8',
      thumbnailUrl: 'https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=400',
      orderPriority: 6,
    },
    {
      title: 'MyTime Movie Network',
      category: 'MOVIES',
      sourceType: 'M3U8_FAST',
      externalId: 'https://appletree-mytime-samsungbrazil.amagi.tv/playlist.m3u8',
      thumbnailUrl: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=400',
      orderPriority: 5,
    },
    {
      title: 'TV Séries Clássicas',
      category: 'MOVIES',
      sourceType: 'M3U8_FAST',
